(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[179], {
                ...
                i) {
                    if (i.startsWith("/")) {
                        ...
                        return Promise.all([r.router.pageLoader.getPageList(), u.getClientBuildManifest()]).then(t=>{
                            ...
                            let u = n.includes(f) ? f : U(h.normalizeLocalePath(x.removeBasePath(c.pathname), r.router.locales).pathname, n);
        ...
        class Y {
            ...
            change(e, t, r, o, i) {
                ...
                return n(function*() {
                    ...
                    l._inFlightRoute && l.clc && (R || Y.events.emit("routeChangeError", L(), l._inFlightRoute, H),
                    l.clc(),
                    l.clc = null),
                    ...
                    if (!h && l.onlyAHashChange(q) && !Z) {
                        ...
                        try {
                            ...
                            throw d.default(z) && z.cancelled && Y.events.emit("routeChangeError", z, q, H),
                            z
                        }
                        return Y.events.emit("hashChangeComplete", r, H),
                        !0
                    }
                    ...
                    if (o.shallow && er && (V = l.pathname),
                    h && er && (p = !1),
                    p && "/_error" !== V && (o._shouldResolveHref = !0,
                    G.pathname = U(V, n),
                    ...
                    try {
                        ...
                        h && "/_error" === V && (null == (ec = self.__NEXT_DATA__.props) ? void 0 : null == (ed = ec.pageProps) ? void 0 : ed.statusCode) === 500 && (null == eb ? void 0 : eb.pageProps) && (eb.pageProps.statusCode = 500);
                        ...
                        if (!ek) {
                            ...
                            eP)
                                throw h || Y.events.emit("routeChangeError", eP, q, H),
                                eP;
            ...
            getRouteInfo(e) {
                let {route: t, pathname: r, query: o, as: i, resolvedAs: l, routeProps: u, locale: c, hasMiddleware: f, isPreview: p, unstable_skipClientCache: m, isQueryUpdating: g, isMiddlewareRewrite: y} = e;
                var v = this;
                return n(function*() {
                    let e = t;
                    try {
                        ...
                        if (g && (R.json = self.__NEXT_DATA__.props),
                        E(),
                        (null == R ? void 0 : null == (_ = R.effect) ? void 0 : _.type) === "redirect-internal" || (null == R ? void 0 : null == (P = R.effect) ? void 0 : P.type) === "redirect-external")
                            return R.effect;
                        if ((null == R ? void 0 : null == (S = R.effect) ? void 0 : S.type) === "rewrite") {
                            ...
                            if ((!g || A.includes(M)) && (e = M,
                            r = R.effect.resolvedHref,
                            o = a({}, o, R.effect.parsedAs.query),
                            l = x.removeBasePath(h.normalizeLocalePath(R.effect.parsedAs.pathname, v.locales).pathname),
                            C = v.components[e],
                        ...
                        let {props: N, cacheKey: k} = yield v._getData(n(function*() {
                            if (I) {
                                let {json: e, cacheKey: t} = (null == R ? void 0 : R.json) && !T ? R : yield G({
                        ...
                        return L.__N_SSP && O.dataHref && delete v.sdc[k],
                        v.isPreview || !L.__N_SSG || g || G(Object.assign({}, O, {
                            isBackground: !0,
                            persistCache: !1,
                            inflightCache: v.sbc
                        })).catch(()=>{}
    ...
    8018: function(e) {
        var t, r, n, a, o, i, l, s, u, c, d, f, h, p, m, g, y, v, _, P, b, S, w, E, x, C, j, O, R, M, A, L, T, I, N, k, D, B, H, F, U, q, W, Z, z, G;
        (t = {}).d = function(e, r) {
            for (var n in r)
